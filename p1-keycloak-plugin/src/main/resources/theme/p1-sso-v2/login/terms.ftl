...
<@layout.registrationLayout displayMessage=false; section>
    <#if section = "form">
            ...
            <div>
                ...
                <ul>
                    ...
                    <li>NOTICE: There is the potential that information presented and exported from the Platform One
                        contains Controlled Unclassified Information (CUI). It is the responsibility of all
        ...
        <form class="form-actions flex justify-end gap-6" action="${url.loginAction}" method="POST">
          <button class="btn btn-accent outline w-auto" name="cancel" id="kc-decline" type="submit" value="${msg("doDecline")}">Decline</button>
            <button class="btn btn-primary w-auto" name="accept" id="kc-accept" type="submit" value="${msg("doAccept")}">Accept & log in<span class="icon append arrow-right"></span></button>
        </form>
